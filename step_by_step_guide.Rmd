...
* [`01_Import_private_data.R`](#0201) -  source private data and filter the records in a similar way as Neotoma.
...
After initial data processing, records from Neotoma and Private are merged together.  
